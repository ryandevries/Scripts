...
BEGIN
	...
	SET @SchName02 = 'Development User Full Backups - Sunday 4AM'
	SET @SchName03 = 'Development User Diff Backups - MTWThFSa 4AM'
	SET @SchName04 = 'Development User TLog Backups - Hourly 6AM-2AM'
	SET @SchName05 = 'Development Index Maintenance - Sunday 2AM'
	SET @SchName06 = 'Development User CheckDB - Sunday 3AM'
	SET @SchName07 = 'Development System CheckDB - Daily 7PM'
	SET @SchName08 = 'Development Cleanup - Sunday 11PM'
	...
	SELECT @SchStart01    = 193000, @SchStart02    = 40000,  @SchStart03    = 40000,  @SchStart04    = 60000,  @SchStart05    = 20000,  @SchStart06    = 30000,  @SchStart07    = 190000, @SchStart08    = 230000
	SELECT @SchEnd01      = 235959, @SchEnd02      = 235959, @SchEnd03      = 235959, @SchEnd04      = 15959,  @SchEnd05      = 235959, @SchEnd06      = 235959, @SchEnd07      = 235959, @SchEnd08      = 235959
	-- Create Schedules
